...
export const GAME_BALANCE = {
    ...
    // --- 6b. Circadian modulation for idle need scores (arithmetic-only; used when enabled). ---
    CIRCADIAN_IDLE: {
        MEAL_PEAK_BOOST: 1.25,
        MEAL_OFF_HOURS: 0.85,
        SLEEP_TROUGH_BOOST: 1.2,
        SLEEP_PEAK_REDUCTION: 0.9,
    },
    ...
    THRESHOLDS: {
        ...
        ACTION_THRESHOLD: 50,
        BOREDOM_TO_GO_OUT: 35,
        OUTING_COOLDOWN_TICKS: 20,
        GROCERY_TRIP_INTERVAL_TICKS: 160,
        ...
        // Workday routine (WorkingState lunch / IdleState resets)
        LUNCH_BREAK_HUNGER_THRESHOLD: 35,
    ...
    COSTS: {
        ...
        MAINTENANCE: 25,
        GROCERIES: 15,
        GROCERY_STOCK_TARGET: 8,
        GROCERY_BULK_TRIP_MULTIPLIER: 1.25,
    ...
    WORLD: {
        ...
        AGENT_DEGRADATION_MODIFIER: 0.002,
        FINANCIAL_ANXIETY_DURATION: 96 * 7,
        EVICTION_FAILURE_COUNT: 4,
    },
    ...
    LIFECYCLE: {
        ...
        EMIGRATION_BASE_CHANCE: 0.002,
        EMIGRATION_RENT_FAILURE_THRESHOLD: 7,
        EMIGRATION_MOOD_THRESHOLD: -92,
        /** Max daily roll probability after combining factors (reduces runaway exits). */
        EMIGRATION_DAILY_CAP: 0.012,
        /** Minimum sim-days in city before emigration can trigger (activityStartTick ticks). */
        EMIGRATION_MIN_RESIDENCY_DAYS: 30,
        /** Pressure multiplier applied when agent is employed with non-negative money. */
        EMIGRATION_EMPLOYED_ANCHOR_MULT: 0.4,
        /** Pressure decay when 2+ stress factors stack (diminishing returns). */
        EMIGRATION_STACK_DECAY: 0.7,
        /** Minimum age (years) for emigration consideration. */
        EMIGRATION_MIN_AGE: 20,
        /** Weight for hunger/energy axis in advanced idle scoring (when enabled). */
        IDLE_WEIGHT_HUNGER_ENERGY: 1.0,
        IDLE_WEIGHT_LONELINESS: 0.85,
        IDLE_WEIGHT_BOREDOM: 0.75,
        IMMIGRATION_RATE: 2,
